...
/**
 * JSON wire format carried inside the platform payload: iOS `userInfo["quickActions"]`
 * and the Android intent extra `QuickActions.EXTRA_ACTION`. Flat keys, every field
