...
import io.github.androidpoet.jolt.compose.OnQuickActionLaunch
import io.github.androidpoet.jolt.compose.rememberQuickActionsManager
...
fun App() {
    MaterialTheme {
        ...
        Column(
            ...
            Text("Jolt", style = MaterialTheme.typography.headlineMedium)
