...
import io.github.androidpoet.jolt.JOLT_USER_INFO_KEY
...
private fun userInfoDictionary(payload: String): Map<Any?, *> =
    NSDictionary.dictionaryWithObject(payload, forKey = NSString.create(string = JOLT_USER_INFO_KEY)) as Map<Any?, *>
...
internal fun UIApplicationShortcutItem.toRecord(): ShortcutRecord =
    ShortcutRecord(
        ...
        iconSystemName = null,
        payload = userInfo?.get(JOLT_USER_INFO_KEY) as? String,
    )
